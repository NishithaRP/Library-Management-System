 ...
 * @author Nishitha
 */
public class DeafaulterList extends javax.swing.JFrame {

    /**
     * Creates new form DeafaulterList
     */
    public DeafaulterList() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeafaulterList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeafaulterList().setVisible(true);
            }
        });
    }
